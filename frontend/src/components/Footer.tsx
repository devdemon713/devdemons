      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h3 className="text-lg font-semibold mb-2">About Agro Connect</h3>
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <ul className="text-sm">
              ...
              <li><a href="#" className="hover:text-primary-300">Contact Us</a></li>
            </ul>
          </div>
        ...
        <div className="mt-8 border-t border-primary-700 pt-6 text-sm text-center">
          &copy; {new Date().getFullYear()} Agro Connect. All rights reserved.
        </div>
      </div>
    </footer>
  );
